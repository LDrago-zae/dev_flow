...
class AppAnimations {
  ...
  static Animation<Offset> fadeInUp(AnimationController controller, {double offset = 0.5}) {
    return Tween<Offset>(
  ...
  static Animation<Offset> fadeOutUp(AnimationController controller, {double offset = 0.5}) {
    return Tween<Offset>(
      begin: Offset.zero,
      end: Offset(0, -offset),
    ).animate(CurvedAnimation(
  ...
  // Slide in from right
  static Animation<Offset> slideInRight(AnimationController controller, {double offset = 0.5}) {
    return Tween<Offset>(
  ...
  // Slide out to left
  static Animation<Offset> slideOutLeft(AnimationController controller, {double offset = 0.5}) {
    return Tween<Offset>(
      begin: Offset.zero,
      end: Offset(-offset, 0),
    ).animate(CurvedAnimation(
  ...
  // Scale in animation
  static Animation<double> scaleIn(AnimationController controller, {double begin = 0.8, double end = 1.0}) {
    return Tween<double>(
      begin: begin,
      end: end,
    ).animate(CurvedAnimation(
  ...
  // Scale out animation
  static Animation<double> scaleOut(AnimationController controller, {double begin = 1.0, double end = 0.8}) {
    return Tween<double>(
      begin: begin,
      end: end,
    ).animate(CurvedAnimation(
