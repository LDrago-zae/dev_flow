          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                ...
                style: AppTextStyles.bodyMedium.copyWith(color: DarkThemeColors.textSecondary),
              ),
              ...
              TextFormField(
                ...
                style: AppTextStyles.bodyMedium.copyWith(color: DarkThemeColors.light),
              ...
              TextFormField(
                ...
                style: AppTextStyles.bodyMedium.copyWith(color: DarkThemeColors.textPrimary),
              ...
              Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: RichText(
                      text: TextSpan(
                        style: AppTextStyles.bodySmall.copyWith(color: DarkThemeColors.textSecondary),
                        children: [
                          const TextSpan(text: 'I agree to '),
                          TextSpan(
                            text: 'Terms & Conditions',
                            style: AppTextStyles.bodySmall.copyWith(color: DarkThemeColors.primary100),
                          ),
              ...
              Row(
                children: [
                  const Expanded(
                    child: Divider(color: DarkThemeColors.border, thickness: 1),
                  ),
                  Padding(
                ...
                child: Wrap(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Text(
                        'Sign In',
                        style: AppTextStyles.bodySmall.copyWith(color: DarkThemeColors.primary100, fontWeight: FontWeight.w600),
                      ),
                    ),
                  ],
                ),
